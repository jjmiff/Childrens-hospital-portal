          ...
          <div className="space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">
                Having an operation can feel a bit scary, but we're here to help
            ...
            <section className="bg-blue-50 rounded-2xl p-6 border-2 border-blue-200">
              ...
              <p className="text-gray-700 mb-4">
                Surgery (also called an operation) is when doctors fix or help a
                part of your body while you're asleep. You won't feel anything
                because you'll be given special medicine called anesthetic that
                makes you sleep deeply.
              </p>
              <p className="text-gray-700">
                The doctors are specially trained and will take really good care
            ...
            <section className="bg-purple-50 rounded-2xl p-6 border-2 border-purple-200">
              ...
              <h3 className="font-bold text-gray-800 mb-3">The Days Before:</h3>
              <ul className="space-y-2 text-gray-700 mb-4">
                ...
                <li className="flex items-start">
                  <span className="mr-2">🍽️</span>
                  <span>
                    You'll be told when to stop eating and drinking (usually the
                    night before)
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="mr-2">🎒</span>
                  <span>
                    Pack your hospital bag with comfy clothes, pajamas, and your
                    favorite things
                  </span>
                </li>
              </ul>

              <h3 className="font-bold text-gray-800 mb-3">On the Day:</h3>
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="mr-2">💬</span>
                  <span>
                    The anesthetist (sleep doctor) will visit you to explain how
                ...
                <li className="flex items-start">
                  <span className="mr-2">👨‍👩‍👧</span>
                  <span>
                    Your parent or carer can stay with you until you go to sleep
                  </span>
                </li>
              </ul>
            </section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    might smell funny but it's safe!), or have medicine through
                    a small tube in your hand. Either way, you'll fall asleep
                    very quickly - usually in less than a minute!
                  </p>
                </div>
            ...
            <section className="bg-yellow-50 rounded-2xl p-6 border-2 border-yellow-200">
              ...
              <h3 className="font-bold text-gray-800 mb-3">Waking Up:</h3>
              <p className="text-gray-700 mb-4">
              ...
              <ul className="space-y-2 text-gray-700 mb-4">
                ...
                <li className="flex items-start">
                  <span className="mr-2">🤒</span>
                  <span>
                    A bit sore where the operation was (you'll get medicine for
                    pain)
                  </span>
                </li>
                <li className="flex items-start">
              ...
              <p className="text-gray-700 mb-4">
                Once you're more awake, you'll go back to your bed on the ward.
                Your family will be waiting for you there! 👨‍👩‍👧
              </p>

              <h3 className="font-bold text-gray-800 mb-3">Getting Better:</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start">
                  <span className="mr-2">💊</span>
                  <span>Take your medicine when the nurses give it to you</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">🚶</span>
                  <span>
            ...
            <section className="bg-pink-50 rounded-2xl p-6 border-2 border-pink-200">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="mr-3">🎮</span>
                  <span>
                    <strong>Bring entertainment:</strong> Books, tablets, games
                    to keep you busy while you rest
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-3">💬</span>
                  <span>
                    <strong>Talk about your feelings:</strong> It's okay to feel
            ...
            <section className="bg-red-50 rounded-2xl p-6 border-2 border-red-200">
              ...
              <p className="text-gray-700 text-center mb-3">
                ...
                ALWAYS tell a nurse or your parent right away. They're there to
                help you!
              </p>
              <p className="text-gray-700 text-center">
                You can also press the call button next to your bed anytime you
                need help. 🔔
              </p>
            </section>
