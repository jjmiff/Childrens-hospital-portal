              ...
              >
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="mr-2">💪</span>
                    <span>
                      Help your body work better if you have a long-term
                      condition
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2">😴</span>
                    <span>
                      Help you sleep, breathe better, or feel less sick
                    </span>
                  </li>
                </ul>
              </ContentSection>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg p-4 border border-purple-300">
                    ...
                    <p className="text-gray-700 text-sm font-semibold">
                      ...
                      mouth, and swallow quickly. Some tablets can be cut in
                      half if they're too big - ask first!
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-4 border border-purple-300">
                    ...
                    <p className="text-gray-700 text-sm font-semibold">
                      💡 Tips: Look away, take deep breaths, and it'll be over
                      in seconds! Some injections sting a tiny bit, but the
                      nurse can use special numbing cream first.
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-4 border border-purple-300">
                    ...
                    <p className="text-gray-700 text-sm font-semibold">
                      💡 Tips: You can still move around (carefully!) with an
                      IV. Tell a nurse if the tube feels uncomfortable or if you
                      see any redness.
                    </p>
                  </div>
              ...
              <ContentSection bgColor="bg-red-50" borderColor="border-red-200">
                ...
                <ul className="space-y-2 sm:space-y-3 text-gray-700">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Only take YOUR medicine</strong> - never share
                      with friends or take someone else's
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-3 text-xl">📝</span>
                ...
                <ul className="space-y-2 sm:space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      flavored version, or have a nice drink ready to wash it
                      down
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <span className="mr-3">🎁</span>
                    <span>
                      <strong>Reward yourself:</strong> After taking medicine,
                      do something you enjoy like reading a book or playing a
                      game
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-3">💪</span>
                    <span>
                      <strong>Remember why:</strong> Medicine helps you get
                      better and feel good again!
                    </span>
                  </li>
                </ul>
              </ContentSection>
