// HospitalSchool.jsx
// Purpose: Information about continuing education while in hospital
// Age-appropriate explanation of hospital school and learning opportunities
          ...
          <div className="space-y-8">
            ...
            <section className="bg-green-50 rounded-2xl p-6 border-2 border-green-200">
              ...
              <p className="text-gray-700 mb-4">
                ...
                schoolwork, learn new things, and have fun while you're getting
                better.
              </p>
              <p className="text-gray-700">
                The teachers are specially trained to work with children who are
                unwell. They understand that some days you might feel great and
                some days you might need to rest.
              </p>
            </section>
            ...
            <section className="bg-blue-50 rounded-2xl p-6 border-2 border-blue-200">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="mr-3">🧠</span>
                  <span>
                    <strong>Stay sharp:</strong> Keeping your brain active helps
                    you feel better
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-3">⏰</span>
                  <span>
                    <strong>Pass the time:</strong> Hospital days can feel long
                    - school helps time go faster!
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-3">😊</span>
                  <span>
                    <strong>Feel normal:</strong> Doing schoolwork can help you
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    math, and other subjects. They can follow what your regular
                    school is doing, so you don't miss important lessons.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Classes are much smaller than regular school. Sometimes you
                    might work alone with a teacher, or in a tiny group of 2-3
                    children. This means you get lots of help!
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    If you have medical appointments, tests, or just don't feel
                    well enough, that's totally okay! You can do schoolwork when
            ...
            <section className="bg-yellow-50 rounded-2xl p-6 border-2 border-yellow-200">
              ...
              <p className="text-gray-700 mb-4">
                Hospital school can happen in different places depending on how
                you're feeling:
              </p>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Your bed:</strong> If you can't get up, the teacher
                    can bring work to you on the ward
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-3">🎮</span>
                ...
                <li className="flex items-start">
                  <span className="mr-3">💻</span>
                  <span>
                    <strong>Online:</strong> Some hospitals offer online lessons
                    through tablets or computers
                  </span>
                </li>
              </ul>
            </section>
            ...
            {/* What Do I Need? */}
            <section className="bg-pink-50 rounded-2xl p-6 border-2 border-pink-200">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                🎒 What Do I Need to Bring?
              </h2>
              <p className="text-gray-700 mb-4">
                You don't need much! The hospital school has most supplies. But
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="mr-2">💻</span>
                  <span>
                    A tablet or laptop if you have one (check with staff first!)
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">📚</span>
            ...
            <section className="bg-orange-50 rounded-2xl p-6 border-2 border-orange-200">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  <span className="mr-3">📝</span>
                  <span>
                    <strong>Written work:</strong> Worksheets, writing stories,
                    solving problems
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="mr-3">🎮</span>
                  <span>
                    <strong>Games and activities:</strong> Educational games on
            ...
            <section className="bg-red-50 rounded-2xl p-6 border-2 border-red-200">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-center justify-center">
                  <span className="mr-2">✅</span>
                  <span>There's no pressure - your health comes first! 💚</span>
                </li>
              </ul>
            </section>

            {/* Tips for Hospital School */}
            <section className="bg-teal-50 rounded-2xl p-6 border-2 border-teal-200">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                ⭐ Tips for Hospital School
              </h2>
              <ul className="space-y-3 text-gray-700">
            ...
            {/* Fun Fact */}
            <section className="bg-indigo-50 rounded-2xl p-6 border-2 border-indigo-200">
              <h3 className="text-xl font-bold text-gray-800 mb-3 text-center">
                🎓 Did You Know?
              </h3>
