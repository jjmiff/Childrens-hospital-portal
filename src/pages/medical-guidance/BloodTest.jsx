            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <ContentSection bgColor="bg-red-50" borderColor="border-red-200">
                ...
                <p className="text-gray-700 mb-4">
                  A blood test is when a nurse or doctor takes a tiny bit of
                  blood from your body. They send it to a special lab where
                  scientists look at it under microscopes to check it's healthy.
                </p>
                <p className="text-gray-700">
                  Your blood can tell doctors lots of important things, like if
                  you need more iron, if you're fighting an infection, or if
                  your medicine is working properly.
                </p>
              </ContentSection>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        The nurse will look for a small tube in your arm called
                        a vein. They might put a soft band around your arm -
                        this helps them see the vein better.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        They'll wipe your skin with a cold wipe to make sure
                        it's really clean.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        The nurse will put a small plaster on your arm, and
                        you're finished! You might get a sticker for being
                        brave. 🌟
                      </p>
                    </div>
                  </div>
              ...
              >
                ...
                <ul className="space-y-2 sm:space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Look away:</strong> You don't have to watch! Look
                      at a picture on the wall or chat to your parent.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-3">😮‍💨</span>
                    <span>
                      ...
                      through your nose and out through your mouth. This helps
                      you relax.
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <span className="mr-3">💬</span>
                    <span>
                      <strong>Tell the nurse:</strong> If you're worried, tell
                      the nurse! They're really kind and can help you feel
                      better.
                    </span>
                  </li>
                  <li className="flex items-start">
              ...
              >
                ...
                <p className="text-gray-700">
                  The results usually take a day or two to come back from the
                  lab. Your doctor will let you know what they find out.
                </p>
              </ContentSection>
