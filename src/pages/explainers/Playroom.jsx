        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2">
              <span aria-hidden="true">🎨</span> Play Areas
            </h2>
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  like you! It's filled with toys, games, books, and art
                  supplies. It's a place where you can have fun, make friends,
                  and forget about being in the hospital for a while.
                </p>
              </div>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-pink-900 mb-2">
                  <span aria-hidden="true">🎮</span> What Can You Do?
                </h4>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-yellow-900 mb-2">
                  <span aria-hidden="true">⏰</span> When Can You Visit?
                </h4>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-indigo-900 mb-2">
                  <span aria-hidden="true">📏</span> Playroom Rules
                </h4>
                <ul className="space-y-2 sm:space-y-3 text-indigo-800">
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-green-900 mb-2">
                  <span aria-hidden="true">🏠</span> Bedside Play
                </h4>
                <p className="text-green-800 mb-2">
                  Can't make it to the playroom? No problem! Play staff can
                  bring activities to your room:
                </p>
