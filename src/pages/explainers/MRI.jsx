        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2">
              <span aria-hidden="true">🔬</span> MRI Scanner
            </h2>
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  camera that can take pictures of the inside of your body
                  without cutting you open! It uses magnets and radio waves
                  (kind of like the radio in a car) to create detailed pictures.
                </p>
              </div>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-blue-900 mb-2">
                  <span aria-hidden="true">🎵</span> It's Noisy!
                </h4>
                <p className="text-blue-800">
                  The MRI machine makes loud knocking and buzzing sounds - like
                  a very loud washing machine! Don't worry, this is totally
                  normal. You'll get special headphones or earplugs to protect
                  your ears.
                </p>
              </ContentSection>
              ...
              <div>
                ...
                <ol className="space-y-2 sm:space-y-3 text-gray-700">
                  <li className="flex gap-3">
                    ...
                    <span>
                      You'll lie down on a special bed that slides into a big
                      tube (like a tunnel).
                    </span>
                  </li>
                  <li className="flex gap-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      You can't bring metal objects (like jewelry) because the
                      MRI uses strong magnets.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="font-bold text-indigo-600">5.</span>
                    <span>
                      When it's done, you can go right back to your room or
                      home!
                    </span>
                  </li>
                </ol>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-green-900 mb-2">
                  <span aria-hidden="true">💪</span> Tips to Make It Easier
                </h4>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  doesn't hurt at all. You won't feel the magnets or radio
                  waves. The only hard part is staying still and dealing with
                  the noise. Some kids even fall asleep during the scan!
                </p>
              </div>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-yellow-900 mb-2">
                  <span aria-hidden="true">❓</span> Questions You Can Ask
                </h4>
                <ul className="space-y-2 sm:space-y-3 text-yellow-800">
