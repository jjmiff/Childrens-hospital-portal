        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2">
              <span aria-hidden="true">🏥</span> Operating Theatre
            </h2>
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  An operating theatre (also called an OR or operating room) is
                  a very clean, special room where doctors do operations
                  (surgery). It's called a "theatre" because long ago, students
                  would sit in seats to watch and learn from surgeons - just
                  like watching a play in a theatre!
                </p>
              </div>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-blue-900 mb-2">
                  <span aria-hidden="true">✨</span> Super Clean!
                </h4>
                <p className="text-blue-800">
                  Operating theatres are probably the cleanest rooms you've ever
                  seen! Everything is spotless and germ-free. That's why
                  everyone wears special clothes, masks, and covers on their
                  shoes. The air is even specially filtered to keep it extra
                  clean!
                </p>
              </ContentSection>
              ...
              <div>
                ...
                <ol className="space-y-2 sm:space-y-3 text-gray-700">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      You can't eat or drink for several hours before (this
                      keeps you safe during the operation)
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="font-bold text-indigo-600">3.</span>
                    <span>
                      You'll meet the surgeon (the doctor doing the operation)
                      and the anaesthetist (who makes you sleep)
                    </span>
                  </li>
                  <li className="flex gap-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      You'll say goodbye to your parents - they'll be waiting
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-purple-900 mb-2">
                  <span aria-hidden="true">😴</span> Going to Sleep
                </h4>
                ...
                <p className="text-purple-800 mt-2">
                  ...
                  won't feel anything during the operation and you won't
                  remember it!
                </p>
              </ContentSection>
                ...
                <div className="space-y-2 sm:space-y-3 text-gray-700">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Depending on your operation, there might be other
                        doctors too
                      </p>
                    </div>
                  </div>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-green-900 mb-2">
                  <span aria-hidden="true">🌟</span> Cool Equipment
                </h4>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    • You might feel sleepy or confused at first - this is
                    normal!
                  </li>
                  <li>• A nurse will be right there with you</li>
                  <li>
                    • You might have a sore throat from the breathing tube
                  </li>
                  <li>
              ...
              >
                <h4 className="text-base md:text-lg font-bold text-yellow-900 mb-2">
                  <span aria-hidden="true">❓</span> Questions You Might Have
                </h4>
                <div className="space-y-2 sm:space-y-3 text-yellow-800">
                  <div>
                    <p className="font-bold">Will it hurt?</p>
                    <p>
                      Not during the operation - you'll be asleep! Afterwards,
                      you might feel sore, but you'll get medicine for pain.
                    </p>
                  </div>
                  <div>
                    <p className="font-bold">What if I wake up during it?</p>
                    <p>
                      This almost never happens. The anaesthetist watches you
                      very carefully the whole time.
                    </p>
                  </div>
                  <div>
