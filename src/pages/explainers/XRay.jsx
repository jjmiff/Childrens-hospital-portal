// XRay.jsx
// Purpose: Explain X-Ray in child-friendly way (FR-5)
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                An X-ray is a special type of picture that can see through your
                skin and muscles to show your bones! It's like having superhero
                vision, but it's a machine doing the work instead of you.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="space-y-3 text-gray-700">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    You need to hold very still for a few seconds - like playing
                    freeze tag!
                  </span>
                </li>
                <li className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                <span className="font-bold text-green-600">No!</span> Getting an
                X-ray doesn't hurt at all. You won't feel anything when the
                picture is taken. The only tricky part might be holding still or
                staying in one position if you have an injury, but the
